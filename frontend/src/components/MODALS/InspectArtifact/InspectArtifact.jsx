...
function renderTab(current, collectionType, setCollectionType, currentArtifactData) {
  switch (current) {
    case 0:
      return <InspectPhysical currentArtifactData={currentArtifactData} />;
    case 1:
      return <InspectContacts collectionType={collectionType} currentArtifactData={currentArtifactData} />;
    case 2:
      return <InspectAcquisition collectionType={collectionType} setCollectionType={setCollectionType} currentArtifactData={currentArtifactData} />;
  }
}
...
function InspectArtifact(props) {
  ...
  if (!props.currentArtifactData) return null;
      ...
      <Modal.Body>
        <div className="artifact-info-container">
          <div className="artifact-info-left">
            <PrimaryView pictures={props.pictures} setPictures={props.setPictures} currentArtifactData={props.currentArtifactData} setShow={props.setShow} refreshThumbnails={props.refreshThumbnails}/>
