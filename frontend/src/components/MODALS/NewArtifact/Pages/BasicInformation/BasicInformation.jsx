...
function BasicInformation({ nextStep, artifactNames, setArtifactNames, artifactIdentifiers, setArtifactIdentifiers, artifactCategories, setArtifactCategories, categories, rooms}){

    //Debugging...
    useEffect(() => {
        console.log(artifactCategories);
        console.log("roomID: " + artifactIdentifiers.roomID);
        console.log("CatalogueNo: " + artifactIdentifiers.catalogueNo)
    ...
    const isFormValid =
        artifactNames.englishName.trim() !== "" &&
        artifactIdentifiers.accessionNo.trim() !== "" &&
        artifactIdentifiers.catalogueNo !== "" &&
        artifactIdentifiers.roomID !== "";
                    ...
                    <div className="stepper-artifact-categories-container">
                        ...
                        {categories && categories.map((category) => (
                            <label key={category.categoryid} className="stepper-artifact-category-fields">
                                <input type="checkbox" name="categories" value={category.categoryid} checked={artifactCategories.includes(category.categoryid)} onChange={handleCategoryChange}/>
